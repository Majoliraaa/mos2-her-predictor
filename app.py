...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with col1:
        st.markdown(
            ...
            "<b>Regime:</b> Thermodynamic equilibrium. High T (600–900°C), high S partial pressure.<br>"
            "→ 2H phase is thermodynamically stable → forms preferentially.<br><br>"
            "<b>Homogeneity:</b> cm-scale uniform coverage. GB density ~0.04 µm⁻¹ (ACS AMI).<br><br>"
            "<b>S-vacancy control:</b> Harder to tune — coupled to T and S atmosphere.<br><br>"
            "<b>ECSA:</b> Fewer grain boundaries → lower ECSA density but higher uniformity.<br><br>"
            "<b>Phase stability:</b> 2H thermodynamically stable at RT. Reproducible Tafel slopes.<br><br>"
            "<b>Stage 2 access:</b> Requires post-synthesis treatment (plasma, H₂ annealing)."
            "</div>", unsafe_allow_html=True)
    with col2:
        st.markdown(
            "<div class='synth-mbe'>"
            "<b>🔬 MBE / Physical Synthesis</b><br><br>"
            "<b>Regime:</b> Kinetic control. S and Mo arrive independently → non-equilibrium growth.<br>"
            "→ S-deficiency during growth spontaneously generates twin grain boundaries (Ma et al. ACS Nano 2017).<br><br>"
            "<b>Homogeneity:</b> Layer-by-layer precision. But lateral homogeneity can vary at nm scale.<br><br>"
            "<b>S-vacancy control:</b> S/Mo flux ratio directly controls vacancy density → Stage 1/2 engineering.<br><br>"
            "<b>ECSA:</b> Higher GB density possible → higher ECSA. "
            "Jeon M6.0: ECSA=9.2 cm² (highest in dataset) despite 20 layers.<br><br>"
            "<b>Phase stability:</b> Thermodynamically metastable phases possible. Structure may not be fully stabilized.<br><br>"
            "<b>Stage 2 access:</b> Direct via S-flux reduction during growth."
            "</div>", unsafe_allow_html=True)
